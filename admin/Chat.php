...
// ดึงข้อมูลผู้สมัครทั้งหมดจากตาราง job_applications และ job_listings1
                    ...
                    <tbody>
                        <?php while ($row = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td><a href="chat_room.php?id=<?= $row['id']; ?>" class="details-link">เริ่มแชท</a></td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
                </table>
            <?php else: ?>
                <p style="padding: 20px; text-align: center; color: #e74c3c; font-weight: bold;">ไม่พบข้อมูลผู้สมัคร</p>
            <?php endif; ?>
